...
The 198 tools cost about **312 KB of schema, ~80,000 tokens**, held for the
...
Every one of the 198 tools has a typed Pydantic return, so the server can
...
Every one of the 198 tools declares `readOnlyHint: true` and
