...
The 187 tools cost about **288 KB of schema, ~74,000 tokens**, held for the
...
Every one of the 187 tools has a typed Pydantic return, so the server can
...
Every one of the 187 tools declares `readOnlyHint: true` and
