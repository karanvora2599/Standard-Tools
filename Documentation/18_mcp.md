...
The 220 tools cost about **358 KB of schema, ~92,000 tokens**, held for the
...
Every one of the 220 tools has a typed Pydantic return, so the server can
...
Every one of the 220 tools declares `readOnlyHint: true` and
