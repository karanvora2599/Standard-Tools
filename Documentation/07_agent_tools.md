...
```python
SYSTEM = """
You are a quantitative analyst assistant with access to a 179-tool financial
...
SYSTEM = """
You are a quantitative investment analyst. You have access to a 179-tool
