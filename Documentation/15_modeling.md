...
A second, independent runtime alongside the 180-tool
...
example script that does not use the 180-tool surface: it passes
...
(`run_signal_panel_backtest`, in the *other* 180-tool surface).
...
same `audit._run_and_record` the 180-tool surface uses — no parallel audit
implementation.
...
modeling runtime is deliberately independent of the 180-tool surface rather
