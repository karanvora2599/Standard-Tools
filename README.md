...
| `data` | 17 | 19 KB | get the bytes, and say what they can and cannot support |
...
| `Documentation/07_agent_tools.md` | Core 14 LLM tools, the full 178-tool analysis registry, Pydantic models, end-to-end agent loop |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 207 tools by runtime, with the description the model sees and every argument name |
