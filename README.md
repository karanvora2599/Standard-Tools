...
| `modeling` | 22 | 82 KB | build, fit and score a model — one ordered pipeline |
...
| `feature_lab` | 9 | 29 KB | what each feature measures and predicts, before fitting |
...
| `Documentation/07_agent_tools.md` | Core 14 LLM tools, the full 180-tool analysis registry, Pydantic models, end-to-end agent loop |
...
| `Documentation/15_modeling.md` | The separate 22-tool modeling runtime: feature catalog and feature report, regression/classification/ranking/survival targets, leakage-purged walk-forward validation, sample weighting, the model adapters, point-in-time joins, the content-addressed model registry, lifecycle stages and drift monitoring, the model→backtest bridge, portfolio evaluation of OOS predictions, and what's explicitly deferred |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 211 tools by runtime, with the description the model sees and every argument name |
