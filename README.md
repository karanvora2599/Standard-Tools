...
| `microstructure` | 16 | 20 KB | what the market will charge you to trade |
...
| `modeling` | A separate 17-tool runtime for building walk-forward-validated statistical models from this library's own features, plus registry browsing and pre-flight spec validation | [15](Documentation/15_modeling.md) |
...
| `Documentation/07_agent_tools.md` | Core 14 LLM tools, the full 174-tool analysis registry, Pydantic models, end-to-end agent loop |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 200 tools by runtime, with the description the model sees and every argument name |
