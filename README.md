...
|---|---:|---:|---|
| `research` | 42 | 48 KB | what is this asset, and what is its statistical structure |
| `data` | 18 | 25 KB | get the bytes, and say what they can and cannot support |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 228 tools by runtime, with the description the model sees and every argument name |
