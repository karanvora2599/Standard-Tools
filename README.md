...
| `delta_one` | 17 | 34 KB | which instrument is the cheapest way to hold this exposure |
...
| `data` | Fetch OHLCV, returns panels, tick tapes and quotes, and publish them as `sqt://` references every other runtime reads | [26](Documentation/26_data.md) |
...
| `Documentation/07_agent_tools.md` | Core 14 LLM tools, the full 152-tool analysis registry, Pydantic models, end-to-end agent loop |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 198 tools by runtime, with the description the model sees and every argument name |
