...
| `modeling` | 31 | 145 KB | build, fit and score a model — one ordered pipeline |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 220 tools by runtime, with the description the model sees and every argument name |
