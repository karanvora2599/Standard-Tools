...
| `modeling` | 25 | 106 KB | build, fit and score a model — one ordered pipeline |
...
| `feature_lab` | 9 | 33 KB | what each feature measures and predicts, before fitting |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 214 tools by runtime, with the description the model sees and every argument name |
