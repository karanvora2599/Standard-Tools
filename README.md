...
- **Agent-first design** — every tool returns a Pydantic model. 46 LLM-callable tools with OpenAI/Anthropic function-calling schemas, including two bring-your-own-signal tools, plus a separate 8-tool modeling runtime. Errors are written to be self-correcting rather than merely accurate.
