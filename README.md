...
| `delta_one` | 9 | 16 KB | which instrument is the cheapest way to hold this exposure |
| `microstructure` | 15 | 19 KB | what the market will charge you to trade |
...
| `Documentation/20_tool_index.md` | **Generated** index of all 187 tools by runtime, with the description the model sees and every argument name |
