...
of the library's 26 tools instead of all of them. Shrinking the tool list
...
def _scoped_tools(tool_names: Optional[List[str]]) -> list[ToolParam]:
    """
    Full 26-tool registry by default; filtered to tool_names when given.
...
def run_agent(
    ...
    tool_names: if given, the model only ever sees this subset of the 26
