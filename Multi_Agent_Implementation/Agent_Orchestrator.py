...
Tools' 28 agent tools: instead of one agent choosing among all 28 tools
...
The orchestrator's own "tools" are not the library's 28 — they are six
...
Why this helps over a single flat 28-tool agent: a worker that was never
