"""
Agentic Pair Trader — Anthropic / Claude Haiku.
Claude scans for cointegrated pairs and produces a trade plan with position sizing.
"""
...
if __name__ == "__main__":
    log_file = setup_logging("agent_pair_trader_anthropic")
