"""
Shared utilities for all agentic scripts — Anthropic provider.
...
def run_agent(
    ...
    Haiku 4.5 supports up to 8096 output tokens per call.
    ...
    Python thread, but the loop reports the timeout and moves on rather than
