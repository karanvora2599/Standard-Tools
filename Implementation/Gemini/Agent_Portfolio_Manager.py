"""
Agentic Portfolio Manager — Google Gemini 2.0 Flash.
Gemini autonomously reviews the portfolio and produces a rebalancing recommendation.
"""
...
if __name__ == "__main__":
    log_file = setup_logging("agent_portfolio_gemini")

    _header("Agentic Portfolio Manager — Gemini 2.0 Flash")
