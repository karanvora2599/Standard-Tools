"""
Agentic Fundamental Analyst — Google Gemini 2.0 Flash.
...
if __name__ == "__main__":
    log_file = setup_logging("agent_fundamental_analyst_gemini")

    _header("Agentic Fundamental Analyst — Gemini 2.0 Flash")
