"""
Agentic Factor Researcher — OpenAI / GPT-4o mini.
GPT runs a multi-factor study and synthesises a factor research note.
"""
...
Step 2 — Rolling stability check
  For each asset, inspect rolling_alpha_tail and rolling_loadings_tail.
...
if __name__ == "__main__":
    log_file = setup_logging("agent_factor_researcher_openai")
