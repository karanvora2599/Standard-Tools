"""
Agentic Risk Monitor — OpenAI / GPT-4o mini.
GPT audits a portfolio's risk profile and fires alerts for threshold breaches.
"""
...
if __name__ == "__main__":
    log_file = setup_logging("agent_risk_monitor_openai")

    _header("Agentic Risk Monitor — GPT-4o mini")
